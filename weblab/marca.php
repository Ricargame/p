					   ...
					   <div class="table-title">
					     <div class="row">
						     <div class="col-sm-6 p-0 flex justify-content-lg-start justify-content-center">
							    <h2 class="ml-lg-2">Registro Marca de Camiones</h2>
							 </div>
...
<form action="Control/Registro_Marca.php" div class="modal fade" tabindex="-1" id="addEmployeeModal" role="dialog">
...
<form action="Control/Editar_Marca.php">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-success">Eliminar</button>
					 ...
					 <!----Eliminar Datos--------->
					 <form action="Control/Eliminar_Marca.php">
