	 ...
	 <div id="sidebar">
		...
		<ul class="list-unstyled component m-0">
		  ...
		  <ul class="collapse list-unstyled menu" id="homeSubmenu3">
		     <li><a href="#">Todod los maestros y movimientos </a></li>
					   ...
					   <div class="table-title">
					     <div class="row">
						     <div class="col-sm-6 p-0 flex justify-content-lg-start justify-content-center">
							    <h2 class="ml-lg-2">Registro de Producto</h2>
							 </div>
...
<form action="Control/Registro_Producto.php" div class="modal fade" tabindex="-1" id="addEmployeeModal" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Registrar Modelo de Camiones</h5>
...
<form action="Control/Editar_Producto.php">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
	  ...
	  <div class="modal-body">
        <div class="form-group">
		    <label>Nombre del Producto</label>
			 <input type="hidden" class="form-control" id="formulario2" name="id" value="">
			<input type="text" class="form-control" id="formulario" name="edit" value="">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-success">Eliminar</button>
					 ...
					 <!----Eliminar Datos--------->
					 <form action="Control/Eliminar_Producto.php">
 ...
 function editar(id,nombre){
                document.getElementById("formulario").value=nombre;
