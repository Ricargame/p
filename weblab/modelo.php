					   ...
					   <div class="table-title">
					     <div class="row">
						     <div class="col-sm-6 p-0 flex justify-content-lg-start justify-content-center">
							    <h2 class="ml-lg-2">Registro Modelo de Camiones</h2>
							 </div>
...
<form action="Control/Registro_Modelo.php" div class="modal fade" tabindex="-1" id="addEmployeeModal" role="dialog">
...
<form action="Control/Editar_Modelo.php">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-success">Eliminar</button>
					 ...
					 <!----Eliminar Datos--------->
					 <form action="Control/Eliminar_Modelo.php">
