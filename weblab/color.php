					   ...
					   <div class="table-title">
					     <div class="row">
						     <div class="col-sm-6 p-0 flex justify-content-lg-start justify-content-center">
							    <h2 class="ml-lg-2">Registro Color </h2>
							 </div>
...
-->
						<?php
							while ($row=$datos->fetch_assoc()){?>
								...
								<th>
    							   <a href=#editEmployeeModal  class="edit" data-toggle="modal" id="edit"  onclick=editar(<?php echo $row["Nombre"] ?>) >
    							   <i class="material-icons"  data-toggle="tooltip" title="Edit">&#xE254;</i>
    							   </a>
...
<form action="Control/Registro_Color.php" div class="modal fade" tabindex="-1" id="addEmployeeModal" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Registrar Marca de Camiones</h5>
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-success">Eliminar</button>
					 ...
					 <!----Eliminar Datos--------->
					 <form action="Control/Eliminar_Color.php">
